...
public class FriendSuggestion {
	...
	static class Vertex {
		...
		// function to create the graph and reverse graph. forwPriorityQ for graph and
		// revPriorityQ for reverse graph.
	...
	// function to relax edges i.e traverse only the adjacent vertices of the given
	// vertex.
	...
	public static long computeDistance(Vertex[] graph, Vertex[] reverseGraph, int s, int t, int queryId) {
		...
		for (int i = 0; i < graph.length; i++) {
			...
			// check if extratced vertex also processed in the reverse graph. If yes find
			...
			// check if extracted vertex is also processed in the forward graph. If yes find
			// the shortest distance.
	...
	// function to find the shortest distance from the stored processed vertices of
	// both forward and reverse graph.
	private static long shortestPath(Vertex[] graph, Vertex[] reverseGraph,
			ArrayList<Integer> forgraphprocessedVertices, ArrayList<Integer> revgraphprocessedVertices, int queryId) {
