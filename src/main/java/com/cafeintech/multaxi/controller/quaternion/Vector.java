...
public abstract class Vector<ResultType extends Vector<ResultType>> {
	...
	/**
	 * are these two vectors almost the same? they both have the same x and y values
	 * (within epsilon).
	 * 
	 ...
	 * this vector creating a new vector object. If the provided vector is null, an
	 * exception is thrown.
	 * 
